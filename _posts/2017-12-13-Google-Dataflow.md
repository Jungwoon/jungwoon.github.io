...
아래 링크를 참조하여 서비스 계정키(JSON)을 받습니다

[](https://jungwoon.github.io/google%20cloud/2017/11/17/Get-Service-Account-Key/)

다운받은 서비스 계정키를 .bashrc안에 `GOOGLE_APPLICATION_CREDENTIALS`변수에 경로를 잡아줍니다
...
마지막으로 Google Cloud Console에서 Dataflow를 사용할 수 있도록 API 사용설정을 해줍니다
